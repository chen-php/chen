            ...
            <div class="layui-row">
                <form class="layui-form"  method="post">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text"  value="2" id="category" name="category" required="" 
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="{{$one->profession}}">
                      </div>
                  </div>
                   <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input  type="text" rows="3" name="address" class="layui-input" value="{{$one->address}}"></input>
                      </div>
                  </div>
                  <div class="layui-form-item">
