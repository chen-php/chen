                ...
                <form class="layui-form"  method="post">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="{{$one->schoolyear}}">
                      </div>
                  </div>
                  <div class="layui-form-item">
                      <label for="username" class="layui-form-label">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="{{$one->term}}">
                      </div>
                  </div>
                  <div class="layui-form-item">
                      <label for="username" class="layui-form-label">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="{{$one->sname}}">
                      </div>
                  </div>
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input">
                           @foreach($teacher as $v)
                                    <option value="{{$v['sid']}}" {{ isset($v['sid']) && $v['sid'] == $one->tid ? 'selected' : '' }}>{{$v['username']}}</option>
                            @endforeach
                          </select>
                      </div>
                  </div>
