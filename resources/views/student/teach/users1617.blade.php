                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                             <p>请选择评教学年与学期：</p>
                            <form class="layui-form layui-col-space5" method="post" action="{{url('student/studentTeachList')}}">
                                 ...
                                 @foreach($lists as $v)
                                  <tr>
                                    ...
                                    @if($v['score']==0||$v['score']=="")
                                      <a title="评教"  onclick="xadmin.open('评教','{{route('student/studentTeachA', ['tid' => $v['tid'],'mid'=>$v['id'],'term'=>$v['term'],'schoolyear'=>$v['schoolyear']])}}',600,400)" href="javascript:;">
