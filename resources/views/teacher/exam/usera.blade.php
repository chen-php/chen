                ...
                <form class="layui-form"  method="post">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="{{$one->score}}">
                      </div>
                  </div>
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input">
                                <option value="{{$student[0]['sid']}}">{{$student[0]['username']}}</option>
                        </select>
                      </div>
                  </div>
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                         <select type="text" id="sid" name="sid" required="" 
                          autocomplete="off" class="layui-input">
                               <option value="{{$subject[0]['id']}}">{{$subject[0]['sname']}}</option>
                        </select>
                      </div>
                  </div>
                  <div class="layui-form-item">
